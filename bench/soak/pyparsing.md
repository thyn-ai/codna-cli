...
_Generated 2026-06-28 07:12 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-pyparsing

_repo: https://github.com/pyparsing/pyparsing · issue: There is a subtle edge-case bug in pyparsing causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | __get__, _lazyclassproperty | 1,116,958→5,982 (187× smaller) | 1743 sym idx (16.0s) · 10 recalled | 7s | $0.049 | ok |
| Cursor | composer-2.5-fast | pyparsing/core.py | 73,608 | — | 141s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | pyparsing/core.py, tests/test_unit.py | 1,408,592 | — | 118s | $0.377 est | ok |

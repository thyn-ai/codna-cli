...
_Generated 2026-06-28 05:56 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-h11

_repo: https://github.com/python-hyper/h11 · issue: There is a subtle edge-case bug in h11 causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _keep_alive | 93,326→5,935 (16× smaller) | 255 sym idx (2.6s) · 10 recalled | 8s | $0.042 | ok |
| Cursor | composer-2.5-fast | h11/_connection.py | 125,163 | — | 120s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | h11/_connection.py, h11/tests/test_connection.py | 1,152,192 | — | 92s | $0.364 est | ok |

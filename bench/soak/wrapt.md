...
_Generated 2026-06-28 08:50 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-wrapt

_repo: https://github.com/GrahamDumpleton/wrapt · issue: There is a subtle edge-case bug in wrapt causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _cached, getter | 398,842→5,937 (67× smaller) | 2077 sym idx (18.9s) · 10 recalled | 12s | $0.086 | ok |
| Cursor | composer-2.5-fast | — | 62,773 | — | 354s | Composer (subscription — no per-token rate) | success |
| Codex | gpt-5.4 | src/wrapt/caching.py, tests/core/test_lru_cache.py | 8,067,405 | — | 386s | $1.725 est | ok |

...
_Generated 2026-06-28 06:34 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-multidict

_repo: https://github.com/aio-libs/multidict · issue: There is a subtle edge-case bug in multidict causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | chained_call, chained_callable | 172,286→3,667 (47× smaller) | 633 sym idx (6.3s) · 10 recalled | 9s | $0.038 | ok |
| Cursor | composer-2.5-fast | multidict/_multidict_py.py | 178,401 | — | 293s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | multidict/_multidict_py.py, tests/test_multidict.py, tests/t | 2,470,228 | — | 212s | $0.741 est | ok |

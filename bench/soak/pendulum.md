...
_Generated 2026-06-28 04:03 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-pendulum

_repo: https://github.com/sdispater/pendulum · issue: diff_for_humans is wrong across a year boundary_

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | Date, age, quarter | 258,945→4,916 (53× smaller) | 1600 sym idx (14.7s) · 10 recalled | 9s | $0.088 | ok |
| Cursor | composer-2.5-fast | rust/src/python/helpers.rs, tests/datetime/test_diff.py | 137,678 | — | 818s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | rust/src/python/helpers.rs, tests/datetime/test_diff.py | 2,524,003 | — | 196s | $0.697 est | ok |

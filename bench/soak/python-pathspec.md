...
_Generated 2026-06-28 06:48 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-python-pathspec

_repo: https://github.com/cpburnz/python-pathspec · issue: There is a subtle edge-case bug in python-pathspec causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | PathSpec, __init__ | 212,523→4,685 (45× smaller) | 859 sym idx (8.9s) · 10 recalled | 10s | $0.128 | ok |
| Cursor | composer-2.5-fast | pathspec/patterns/gitignore/basic.py, tests/test_03_gitignor | 92,404 | — | 192s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | pathspec/util.py, tests/test_05_pathspec.py | 3,511,426 | — | 155s | $0.725 est | ok |

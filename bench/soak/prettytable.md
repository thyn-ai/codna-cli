...
_Generated 2026-06-28 07:01 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-prettytable

_repo: https://github.com/jazzband/prettytable · issue: There is a subtle edge-case bug in prettytable causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | PrettyTable, align | 101,060→4,831 (21× smaller) | 525 sym idx (4.5s) · 10 recalled | 6s | $0.051 | ok |
| Cursor | composer-2.5-fast | src/prettytable/prettytable.py | 53,219 | — | 202s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | src/prettytable/prettytable.py, tests/test_prettytable.py | 3,603,305 | — | 202s | $0.889 est | ok |

...
_Generated 2026-06-28 06:07 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-itsdangerous

_repo: https://github.com/pallets/itsdangerous · issue: There is a subtle edge-case bug in itsdangerous causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | base64_encode, want_bytes | 28,485→5,174 (6× smaller) | 140 sym idx (2.2s) · 10 recalled | 6s | $0.041 | ok |
| Cursor | composer-2.5-fast | src/itsdangerous/encoding.py | 112,694 | — | 148s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | src/itsdangerous/encoding.py, tests/test_itsdangerous/test_s | 1,086,814 | — | 102s | $0.363 est | ok |

...
_Generated 2026-06-28 08:44 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-websockets

_repo: https://github.com/python-websockets/websockets · issue: There is a subtle edge-case bug in websockets causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | claude-sonnet-4-6 | — | — | 2975 sym idx (33.5s) · 0 recalled | 50s | — | exit 1 |
| Cursor | composer-2.5-fast | — | 144,027 | — | 722s | Composer (subscription — no per-token rate) | success |
| Codex | gpt-5.4 | src/websockets/asyncio/server.py, tests/asyncio/test_server. | 3,566,505 | — | 209s | $0.901 est | ok |

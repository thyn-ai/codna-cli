...
_Generated 2026-06-28 06:03 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-idna

_repo: https://github.com/kjd/idna · issue: There is a subtle edge-case bug in idna causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | Codec, IncrementalEncoder, decode | 227,010→4,632 (49× smaller) | 6475 sym idx (113.5s) · 10 recalled | 7s | $0.044 | ok |
| Cursor | composer-2.5-fast | idna/codec.py | 85,898 | — | 454s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | idna/codec.py, tests/test_idna_codec.py | 2,038,972 | — | 177s | $0.710 est | ok |

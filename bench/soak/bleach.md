...
_Generated 2026-06-28 05:22 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-bleach

_repo: https://github.com/mozilla/bleach · issue: There is a subtle edge-case bug in bleach causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | BufferedStream, tell | 204,545→5,355 (38× smaller) | 639 sym idx (5.8s) · 10 recalled | 7s | $0.043 | ok |
| Cursor | composer-2.5-fast | bleach/html5lib_shim.py | 64,265 | — | 153s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | bleach/linkifier.py, tests/test_linkify.py | 3,138,973 | — | 166s | $0.909 est | ok |

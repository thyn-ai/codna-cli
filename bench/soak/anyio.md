...
_Generated 2026-06-28 05:15 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-anyio

_repo: https://github.com/agronholm/anyio · issue: There is a subtle edge-case bug in anyio causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | extract_backend_and_options | 350,990→5,637 (62× smaller) | 2177 sym idx (24.2s) · 10 recalled | 7s | $0.066 | ok |
| Cursor | composer-2.5-fast | src/anyio/_backends/_trio.py | 89,223 | — | 346s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | src/anyio/_backends/_asyncio.py, tests/test_synchronization. | 1,375,081 | — | 172s | $0.497 est | ok |

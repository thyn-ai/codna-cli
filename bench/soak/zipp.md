...
_Generated 2026-06-28 09:01 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-zipp

_repo: https://github.com/jaraco/zipp · issue: There is a subtle edge-case bug in zipp causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _ancestry, _parents | 19,705→2,480 (8× smaller) | 152 sym idx (1.7s) · 10 recalled | 6s | $0.036 | ok |
| Cursor | composer-2.5-fast | — | 65,751 | — | 328s | Composer (subscription — no per-token rate) | success |
| Codex | gpt-5.4 | tests/test_path.py, zipp/__init__.py | 2,669,127 | — | 215s | $0.706 est | ok |

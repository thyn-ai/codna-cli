...
_Generated 2026-06-28 09:27 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-pexpect

_repo: https://github.com/pexpect/pexpect · issue: There is a subtle edge-case bug in pexpect causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | MissingCommandTestCase, testMissingCommand | 161,553→5,815 (28× smaller) | 736 sym idx (6.6s) · 10 recalled | 7s | $0.052 | ok |
| Cursor | composer-2.5-fast | pexpect/expect.py | — | — | 900s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | pexpect/expect.py, tests/test_expect.py | 1,600,170 | — | 178s | $0.388 est | ok |

...
_Generated 2026-06-28 10:00 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-coveragepy

_repo: https://github.com/nedbat/coveragepy · issue: There is a subtle edge-case bug in coveragepy causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | measurable_line | 947,145→5,871 (161× smaller) | 2623 sym idx (22.0s) · 10 recalled | 13s | $0.153 | ok |
| Cursor | composer-2.5-fast | coverage/files.py | 116,132 | — | 121s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | coverage/files.py, tests/test_files.py | 820,880 | — | 68s | $0.248 est | ok |

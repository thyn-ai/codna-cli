...
_Generated 2026-06-28 07:51 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-starlette

_repo: https://github.com/encode/starlette · issue: There is a subtle edge-case bug in starlette causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | wrap_app_handling_exceptions, wrapped_app | 240,449→5,738 (42× smaller) | 1210 sym idx (13.3s) · 10 recalled | 7s | $0.036 | ok |
| Cursor | composer-2.5-fast | starlette/datastructures.py | 83,379 | — | 218s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | starlette/datastructures.py, tests/test_datastructures.py, t | 1,298,714 | — | 129s | $0.384 est | ok |

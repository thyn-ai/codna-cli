...
_Generated 2026-06-28 09:30 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._
...
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _to_unicode | 319,836→5,744 (56× smaller) | 1619 sym idx (19.6s) · 10 recalled | 10s | $0.052 | ok |
| Cursor | composer-2.5-fast | paramiko/hostkeys.py | 133,351 | — | 215s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | paramiko/hostkeys.py, tests/test_hostkeys.py | 1,173,031 | — | 112s | $0.407 est | ok |

...
_Generated 2026-06-28 05:37 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-deepdiff

_repo: https://github.com/seperman/deepdiff · issue: There is a subtle edge-case bug in deepdiff causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _WildcardToken, __eq__, __hash__, __init__, __repr__ | 595,428→5,701 (104× smaller) | 1531 sym idx (13.0s) · 10 recalled | 11s | $0.135 | ok |
| Cursor | composer-2.5-fast | uv.lock | 158,601 | — | 314s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | deepdiff/helper.py, tests/test_helper.py | 4,060,305 | — | 228s | $1.073 est | ok |

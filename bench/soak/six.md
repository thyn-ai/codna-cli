...
_Generated 2026-06-28 09:04 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-six

_repo: https://github.com/benjaminp/six · issue: There is a subtle edge-case bug in six causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _add_doc, _import_module | 33,388→1,393 (24× smaller) | 126 sym idx (1.2s) · 10 recalled | 5s | $0.020 | ok |
| Cursor | composer-2.5-fast | six.py | 70,775 | — | 166s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | six.py, test_six.py | 1,592,183 | — | 147s | $0.520 est | ok |

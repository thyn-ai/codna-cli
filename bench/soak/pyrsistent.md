...
_Generated 2026-06-28 07:15 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-pyrsistent

_repo: https://github.com/tobgu/pyrsistent · issue: There is a subtle edge-case bug in pyrsistent causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _chunks, _do_to_path, _get, _get_keys_and_values, _items, ny | 125,510→5,350 (23× smaller) | 1121 sym idx (9.6s) · 10 recalled | 21s | $0.051 | ok |
| Cursor | composer-2.5-fast | pyrsistent/_pdeque.py | 128,188 | — | 177s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | pyrsistent/_pdeque.py, tests/deque_test.py | 1,020,273 | — | 99s | $0.305 est | ok |

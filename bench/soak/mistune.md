...
_Generated 2026-06-28 06:24 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-mistune

_repo: https://github.com/lepture/mistune · issue: There is a subtle edge-case bug in mistune causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | MarkdownRenderer, __call__, render_referrences | 139,869→5,514 (25× smaller) | 545 sym idx (5.0s) · 10 recalled | 7s | $0.055 | ok |
| Cursor | composer-2.5-fast | src/mistune/__init__.py | 152,560 | — | 296s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | src/mistune/__init__.py, tests/test_misc.py | 4,035,674 | — | 185s | $1.038 est | ok |

...
_Generated 2026-06-28 09:52 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-tinydb

_repo: https://github.com/msiemens/tinydb · issue: There is a subtle edge-case bug in tinydb causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | QueryLike, is_sequence | 65,741→5,708 (12× smaller) | 300 sym idx (3.5s) · 10 recalled | 6s | $0.066 | ok |
| Cursor | composer-2.5-fast | — | 73,636 | — | 283s | Composer (subscription — no per-token rate) | success |
| Codex | gpt-5.4 | tests/test_tinydb.py, tinydb/queries.py | 2,161,520 | — | 175s | $0.677 est | ok |

...
_Generated 2026-06-28 09:08 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-simplejson

_repo: https://github.com/simplejson/simplejson · issue: There is a subtle edge-case bug in simplejson causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _import_speedups | 139,924→5,675 (25× smaller) | 422 sym idx (4.5s) · 10 recalled | 6s | $0.042 | ok |
| Cursor | composer-2.5-fast | — | 273,324 | — | 233s | Composer (subscription — no per-token rate) | success |
| Codex | gpt-5.4 | simplejson/_speedups.c, simplejson/encoder.py, simplejson/te | 3,832,471 | — | 252s | $1.023 est | ok |

...
_Generated 2026-06-28 07:08 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-python-prompt-toolkit

_repo: https://github.com/prompt-toolkit/python-prompt-toolkit · issue: There is a subtle edge-case bug in python-prompt-toolkit causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | Application, __init__ | 557,853→5,296 (105× smaller) | 2601 sym idx (22.2s) · 10 recalled | 10s | $0.049 | ok |
| Cursor | composer-2.5-fast | — | 85,189 | — | 205s | Composer (subscription — no per-token rate) | success |
| Codex | gpt-5.4 | src/prompt_toolkit/input/vt100.py | 6,892,525 | — | 443s | $1.389 est | ok |

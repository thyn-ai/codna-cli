...
_Generated 2026-06-28 04:42 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-tenacity

_repo: https://github.com/jd/tenacity · issue: stop_after_attempt is off by one_

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | __call__, __init__, stop_after_attempt, stop_after_delay | 65,772→2,297 (29× smaller) | 492 sym idx (5.5s) · 10 recalled | 14s | $0.010 | ok |
| Cursor | composer-2.5-fast | tenacity/stop.py | 59,331 | — | 100s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | tenacity/stop.py, tests/test_tenacity.py | 1,126,919 | — | 99s | $0.288 est | ok |

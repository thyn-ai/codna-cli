...
_Generated 2026-06-28 06:57 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-ply

_repo: https://github.com/dabeaz/ply · issue: There is a subtle edge-case bug in ply causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | PlyLogger, __init__, debug, error, warning | 143,527→4,526 (32× smaller) | 1030 sym idx (13.8s) · 10 recalled | 7s | $0.037 | ok |
| Cursor | composer-2.5-fast | src/ply/lex.py | 69,882 | — | 166s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | src/ply/lex.py, tests/testlex.py | 738,205 | — | 76s | $0.241 est | ok |

...
_Generated 2026-06-28 09:58 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-jsonpickle

_repo: https://github.com/jsonpickle/jsonpickle · issue: There is a subtle edge-case bug in jsonpickle causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | has_method | 139,182→5,355 (26× smaller) | 1033 sym idx (10.4s) · 10 recalled | 6s | $0.043 | ok |
| Cursor | composer-2.5-fast | jsonpickle/handlers.py | 107,114 | — | 220s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | jsonpickle/handlers.py, tests/object_test.py | 1,820,871 | — | 141s | $0.467 est | ok |

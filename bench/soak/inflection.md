...
_Generated 2026-06-28 06:05 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-inflection

_repo: https://github.com/jpvanhal/inflection · issue: There is a subtle edge-case bug in inflection causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _irregular, caseinsensitive | 11,434→1,807 (6× smaller) | 36 sym idx (1.6s) · 10 recalled | 7s | $0.020 | ok |
| Cursor | composer-2.5-fast | inflection/__init__.py | 31,679 | — | 92s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | inflection/__init__.py, test_inflection.py | 360,403 | — | 40s | $0.152 est | ok |

...
_Generated 2026-06-28 07:48 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-soupsieve

_repo: https://github.com/facelessuser/soupsieve · issue: There is a subtle edge-case bug in soupsieve causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _FakeParent, __init__, __len__ | 175,841→4,900 (36× smaller) | 808 sym idx (8.0s) · 10 recalled | 6s | $0.047 | ok |
| Cursor | composer-2.5-fast | — | 283,906 | — | 550s | Composer (subscription — no per-token rate) | success |
| Codex | gpt-5.4 | soupsieve/__init__.py, tests/test_api.py | 1,110,055 | — | 76s | $0.342 est | ok |

...
_Generated 2026-06-28 08:52 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-xmltodict

_repo: https://github.com/martinblech/xmltodict · issue: There is a subtle edge-case bug in xmltodict causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _DictSAXHandler, startElement | 30,279→1,406 (22× smaller) | 149 sym idx (2.3s) · 10 recalled | 6s | $0.022 | ok |
| Cursor | composer-2.5-fast | xmltodict.py | 53,723 | — | 83s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | tests/test_xmltodict.py, xmltodict.py | 1,019,925 | — | 82s | $0.286 est | ok |

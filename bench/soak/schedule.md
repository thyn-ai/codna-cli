...
_repo: https://github.com/schedule/schedule · issue: There is a subtle edge-case bug in schedule causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| codna | — | — | — | — | — | — | skipped: clone failed |
| cursor | — | — | — | — | — | — | skipped: clone failed |
| codex | — | — | — | — | — | — | skipped: clone failed |

...
_Generated 2026-06-28 10:09 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-hug

_repo: https://github.com/hugapi/hug · issue: There is a subtle edge-case bug in hug causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _json_converter | 169,210→5,573 (30× smaller) | 1036 sym idx (12.0s) · 10 recalled | 7s | $0.039 | ok |
| Cursor | composer-2.5-fast | hug/interface.py | 136,166 | — | 523s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | hug/api.py, tests/test_decorators.py | 1,537,466 | — | 122s | $0.481 est | ok |

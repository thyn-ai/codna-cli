...
_Generated 2026-06-28 03:09 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._
...
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | TestSendfile, send_file, test_send_file, test_static_file | 306,568→5,769 (53× smaller) | 920 sym idx (8.1s) · 10 recalled | 12s | $0.111 | ok |
| Cursor | composer-2.5-fast | src/flask/helpers.py | — | — | 900s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | src/flask/helpers.py, tests/test_helpers.py | 1,635,883 | — | 150s | $0.526 est | ok |

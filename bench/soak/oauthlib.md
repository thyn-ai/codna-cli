...
_Generated 2026-06-28 06:37 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._

## clone-oauthlib

_repo: https://github.com/oauthlib/oauthlib · issue: There is a subtle edge-case bug in oauthlib causing incorrect behavior in a common code path; locate the responsible function and fix it with a minimal change._

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | quote | 319,439→5,885 (54× smaller) | 1284 sym idx (12.2s) · 10 recalled | 10s | $0.122 | ok |
| Cursor | composer-2.5-fast | oauthlib/oauth2/rfc6749/errors.py, tests/oauth2/rfc6749/test | 56,923 | — | 189s | Composer (subscription — no per-token rate) | ok |
| Codex | gpt-5.4 | oauthlib/oauth2/rfc6749/tokens.py, oauthlib/openid/connect/c | 3,449,435 | — | 223s | $0.845 est | ok |

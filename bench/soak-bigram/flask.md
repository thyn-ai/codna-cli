...
_repo: https://github.com/pallets/flask · issue: send_

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | _make_timedelta | 306,558→2,652 (116× smaller) | 920 sym idx (0.3s) · 10 recalled | 7s | $0.022 | ok |

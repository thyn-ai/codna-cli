...
_repo: https://github.com/jd/tenacity · issue: stop_

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | __init__, __or__, stop_any, stop_base | 65,761→2,952 (22× smaller) | 492 sym idx (0.3s) · 10 recalled | 8s | $0.045 | ok |

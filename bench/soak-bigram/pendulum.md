...
_repo: https://github.com/sdispater/pendulum · issue: diff_

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | test_diff_in_hours_negative_no_sign, test_diff_in_hours_nega | 258,935→5,061 (51× smaller) | 1600 sym idx (0.4s) · 10 recalled | 10s | $0.052 | ok |

...
_Generated 2026-06-28 15:48 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._
...
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | OAuth2Token, missing_scopes, old_scopes, scope, scopes | 319,429→5,885 (54× smaller) | 1284 sym idx (0.3s) · 10 recalled | 8s | $0.050 | ok |

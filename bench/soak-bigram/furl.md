...
_Generated 2026-06-28 15:44 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._
...
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | lget | 55,786→1,965 (28× smaller) | 248 sym idx (0.3s) · 10 recalled | 5s | $0.020 | ok |

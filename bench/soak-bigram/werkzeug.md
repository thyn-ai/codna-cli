...
_repo: https://github.com/pallets/werkzeug · issue: secure_

| Engine | Model | Localized | Context tokens in | Memory (Telys) | Time | Cost | Status |
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | __delete__, cached_property | 422,170→1,980 (213× smaller) | 2196 sym idx (0.7s) · 10 recalled | 12s | $0.054 | ok |

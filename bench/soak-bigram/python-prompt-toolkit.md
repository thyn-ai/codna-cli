...
_Generated 2026-06-28 15:52 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._
...
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | Application, __init__ | 557,843→5,296 (105× smaller) | 2601 sym idx (0.7s) · 10 recalled | 9s | $0.049 | ok |

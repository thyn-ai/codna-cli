...
_Generated 2026-06-28 15:58 UTC · 1 repo(s) · each engine runs the same issue headless on its own checkout, no shared infra._
...
|---|---|---|--:|---|--:|--:|---|
| Codna +Telys | gpt-5.4 | WebSocketServerProtocol, __init__ | 585,336→5,879 (100× smaller) | 2975 sym idx (1.0s) · 10 recalled | 9s | $0.081 | ok |

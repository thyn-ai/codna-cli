...
| --- | --- |
| A bug in the CLI or MCP server | [GitHub Issues](https://github.com/thyn-ai/codna-cli/issues) with the `bug` label — include the `codna` version, OS, and a minimal reproduction |
| A feature request | [GitHub Issues](https://github.com/thyn-ai/codna-cli/issues) with the `enhancement` label |
| Usage questions, ideas, show-and-tell | [GitHub Discussions](https://github.com/thyn-ai/codna-cli/discussions) |
| Real-time chat with the community | [Discord](https://discord.gg/w8NDsph9an) |
| Product site | [codna.ai](https://codna.ai) |
